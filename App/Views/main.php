...
<div class="container">
    ...
    <!--step one-->
    <div class="tab">
        <form class="bg-dark text-success mt-3 p-5 rounded-5" id="regFormPart1" action="/store-participant-step-1" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
        ...
        <div class="mb-3">
                ...
                <select class="form-select required"  aria-label="Default select example"  name="country" oninput="this.className = ''">
                   <?php 
                    ...
                    <option selected><?=$country->countryName?></option>
                    <?php endforeach?> 
                    <!-- <option selected>test country</option> -->
                </select>
            </div> 
            <div class="mb-3">
    ...
    <!--step two-->
    <div class="tab">
        <form class="bg-dark text-success mt-3 p-5 rounded-5" id="regFormPart2" action="/store-participant-step-2" method="POST" enctype="multipart/form-data">
    ...
    <div class="tab share">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        ...
        <a href="http://www.facebook.com/sharer.php?s=100&p[title]=<?php echo TW_TEXT ?>&p[url]=<?php echo APP_URL . '/participant/' ?>" onclick="window.open(this.href, this.title, 'toolbar=0, status=0, width=548, height=325'); return false" target="_parent" id="share_fb">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"  viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path class="fbIcon" d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/></svg>
        </a>
        <div style="overflow:auto;">
                <div style="float:right;">
                    <button type="button" class="btn btn-primary m-2" id="prevBtn" onclick="nextPrev(this, -1)">Previous</button>
