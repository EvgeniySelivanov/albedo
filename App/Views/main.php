        ...
        <div class="tab">
            ...
            <div class="date mb-3" data-provide="datepicker">
                ...
                <div class="input-group">
                    <!--Устанавливаю нижнюю границу даты рожденья-->
                    <? $date = new DateTime('now');
                    $maxDate = $date->modify('-80 year')->format('Y-m-d'); 
                    ?>

                    <input type="date" class="form-control required" name="birhtday" id="birhtday" min="<?echo $maxDate;?>" max="<? echo date("Y-m-d"); ?>">
                </div>
            </div>
            <div class="mb-3">
